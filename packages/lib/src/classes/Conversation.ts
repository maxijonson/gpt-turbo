...
export class Conversation {
    /**
     * Gets called when a new Conversation instance is created. The returned plugins will be added to the new Conversation instance.
     *
     * **Warning**: You should always instantiate your plugins inside the function.
     * If you pre-instantiate your plugins outside the function, the same plugin instances will be used for every Conversation instance.
     */
    public static getGlobalPlugins: () => ConversationPlugin[] = () => [];
    ...
    /**
     * Gets a plugin instance that was added to the conversation.
     *
     * @param pluginClass The **class** of the plugin to get.
     * @returns The plugin instance, or `undefined` if the plugin is not found.
     */
    public getPlugin<T extends typeof ConversationPlugin>(pluginClass: T) {
        return this.pluginService.getPlugin(pluginClass);
    }
}
